"""
Django settings for demo_mongo project.
...
MIDDLEWARE_CLASSES = (
    'mongoauth.middleware.SessionMiddleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            TEMPLATE_PATH,
            os.path.join(BASE_DIR, 'mongoauth/templates'),
        ],
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'demo_mongo.wsgi.application'
